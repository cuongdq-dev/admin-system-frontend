...
export const PATH_SIGN_OUT = '/auth/logout';
...
export const PATH_ANALYTICS_CATEGORY_NEWS = '/analytics/category-news';
export const PATH_ANALYTICS_CATEGORY_BOOKS = '/analytics/category-books';
